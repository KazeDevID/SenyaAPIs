...
function Nhsearch(query, page = 1) {
	return new Promise(async(resolve, reject) => {
...
module.exports.getDoujinObj = getDoujinObj;
module.exports.getDoujinsByArtist = getDoujinsByArtist;
module.exports.getDoujinsByTag = getDoujinsByTag;
module.exports.Nhhome = Nhhome;
module.exports.Nhsearch = Nhsearch;
