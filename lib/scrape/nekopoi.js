 ...
 * @param {String} link 
 */
const nekogetHentaiEpisode = async (link) => {
 ...
 * @param {String} link 
 */
const nekogetHentai = async (link) => {
