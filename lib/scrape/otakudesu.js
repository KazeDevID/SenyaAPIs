...
async function otakuDownload(URL) {
	return new Promise((resolve, reject) => {
		axios.get(URL, {headers}).then(res => {
			const $ = cheerio.load(res.data)
...
module.exports = { otakuSearch, otakuInfo, otakuDownload }

// otakuSearch("platinum").then(console.log)
// otakuInfo("https://otakudesu.info/anime/platinum-the-end-sub-indo/").then(console.log)
// otakuDownload("https://otakudesu.info/platinum-the-end-episode-1-sub-indo/").then(console.log)