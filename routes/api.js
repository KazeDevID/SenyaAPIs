...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------KazeDevID'+'Kaze-No-Counter';
...
router.get('/cekapikey', async (req, res, next) => {
	...
	json = JSON.stringify({
		...
		message: `jangan lupa follow Ig @lordagam23_`
	})
} else {
	json = JSON.stringify({
		status: false
...
router.get('/cewe/vietnam', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/asupan/image/vietnam.json`))
...
router.get('/cewe/thailand', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/asupan/image/thailand.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/china', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/asupan/image/china.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/indonesia', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/asupan/image/indonesia.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/korea', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/asupan/image/korea.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/japan', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/asupan/image/japan.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/malaysia', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/asupan/image/malaysia.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/asupan', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/asupan.js`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/asupan/rikagusriani', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/asupan/image/rikagusriani.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/asupan/santuy', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/asupan/image/santuy.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/asupan/ukty', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/asupan/image/ukhty.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/asupan/bocil', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/bocil.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/asupan/ghea', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/geayubi.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/ass', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/ass.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/ahegao', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/ahegao.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/bdsm', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/bdsm.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/blowjob', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/blowjob.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/cuckold', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/cuckold.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/cum', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/cum.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/ero', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/ero.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/femdom', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/femdom.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/foot', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/foot.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/gangbang', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/gangbang.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/glasses', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/glasses.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/hentai', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/hentai.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/hentaigif', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/hnt_gifs.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/jahy', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/jahy.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/masturbation', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/masturbation.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/nsfwNeko', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/nsfwNeko.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/orgy', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/orgy.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/panties', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/panties.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/pussy', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/pussy.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/thighs', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/thighs.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/yuri', async (req, res, next) => {
	...
	if (apikeyInput != `${listkey}`)  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/random/anime/nsfw/yuri.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/wallpaper/cyberspace', async (req, res, next) => {
	...
	if(apikeyInput != `${listkey}`) return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/api/wallpaper/CyberSpace.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/teknologi', async (req, res, next) => {
	...
	if(apikeyInput != `${listkey}`) return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/api/wallpaper/Technology.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/programming', async (req, res, next) => {
	...
	if(apikeyInput != `${listkey}`) return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/api/wallpaper/Programming.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/pegunungan', async (req, res, next) => {
	...
	if(apikeyInput != `${listkey}`) return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/KazeDevID/results/master/api/wallpaper/Mountain.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/search', async (req, res, next) => {
    ...
    if (!film) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter film"})
       ...
       fetch(encodeURI(`https://lk21-api-kaze.herokuapp.com/api/v1/search?q=${film}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/release', async (req, res, next) => {
        var apikeyInput = req.query.apikey
            
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != `${listkey}`) return res.json(loghandler.invalidKey)

       fetch(encodeURI(`https://lk21-api-kaze.herokuapp.com/api/v1/release`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/latest', async (req, res, next) => {
        var apikeyInput = req.query.apikey
            
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != `${listkey}`) return res.json(loghandler.invalidKey)

       fetch(encodeURI(`https://lk21-api-kaze.herokuapp.com/api/v1/latest`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/tvseries', async (req, res, next) => {
	...
	if(apikeyInput != `${listkey}`) return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://lk21-api-kaze.herokuapp.com/api/v1/trending`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/alphabet', async (req, res, next) => {
        var apikeyInput = req.query.apikey,
            alphabet = req.query.alphabet
            
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != `${listkey}`) return res.json(loghandler.invalidKey)
    if (!alphabet) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter tahun"})

       fetch(encodeURI(`https://lk21-api-kaze.herokuapp.com/api/v1/alphabet${alphabet}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/country', async (req, res, next) => {
	...
	if(apikeyInput != `${listkey}`) return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://lk21-api-kaze.herokuapp.com/api/v1/lists/country`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/genre', async (req, res, next) => {
	...
	if(apikeyInput != `${listkey}`) return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://lk21-api-kaze.herokuapp.com/api/v1/lists/genre`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
